# 🌸 xinStar
<img align='right' src='logo.png' width='200px' alt="xinStar logo">
...
[**🖥️ 在线演示**](https://xinStar.mysqil.com/) | [**📝 用户文档**](https://docs.xinStar.mysqil.com/)
...
[📚 阅读完整文档](https://docs.xinStar.mysqil.com/) →

![xinStar Preview](./README.webp)
...
1. **克隆仓库：**
   ```bash
   git clone https://github.com/matsuzaka-yuki/xinStar.git
   cd xinStar
   ```
...
xinStar 支持超越标准 GitHub Flavored Markdown 的增强功能：
...
xinStar 支持将代码和内容分成两个独立的仓库管理,适合团队协作和大型项目。
...
CONTENT_REPO_URL=https://github.com/your-username/xinStar-Content.git
...
- **[Firefly](https://github.com/CuteLeaf/Firefly)** - 感谢提供优秀的布局设计思路，双侧边栏布局、文章双列网格等布局，及部分小组件的设计与实现，让 xinStar 的界面更加丰富。
- **[Twilight](https://github.com/spr-aachen/Twilight)** - 感谢提供灵感和技术支持。Twilight 的动态壁纸模式切换系统、响应式设计和过渡效果显著提升了 xinStar 的使用体验。

## 🍀 贡献者

感谢以下贡献者对本项目做出的贡献，如有问题或建议，请提交 [Issue](https://github.com/matsuzaka-yuki/xinStar/issues) 或 [Pull Request](https://github.com/matsuzaka-yuki/xinStar/pulls)。

<a href="https://github.com/matsuzaka-yuki/xinStar/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=matsuzaka-yuki/xinStar" />
</a>

## ⭐ Star History

[![Star History Chart](https://api.star-history.com/svg?repos=matsuzaka-yuki/xinStar&type=Date)](https://star-history.com/#matsuzaka-yuki/xinStar&Date)
---

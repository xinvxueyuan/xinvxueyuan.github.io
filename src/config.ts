...
export const siteConfig: SiteConfig = {
	title: "xinvStar",
	subtitle: "新v学员个人博客",
	siteURL: "https://xinvstar.xyz/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-09-20", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "970836", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "1282862704", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	// 字体配置
	font: {
		// 使用 Google Fonts：Inter（英文）+ Noto Sans SC（中文）
		asciiFont: {
			// 英文字体 - 优先级最高
			fontFamily: "Inter",
			fontWeight: "400",
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1282862704",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/xinvxueyuan",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "© 2026 xinvStar.Inc. All Rights Reserved. ｜ <a href=\"https://icp.gov.moe/?keyword=20260096\" target=\"_blank\">萌ICP备20260096号</a>", // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to xinvStar Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "https://github.com/xinvxueyuan", // 关于链接
	},
};
